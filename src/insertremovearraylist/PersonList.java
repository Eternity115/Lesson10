...
public class PersonList {
    ...
    public static void main(String[] args) {
        ...
        p[0] = new Person("Andrews, Bob", 47,"ma");
        p[1] = new Person("Davidson, Greg", 24,"ma");
        p[2] = new Person("Folley, Anna", 35,"fem");
        System.out.println("Adding new person: Edwards, Dave");;
        Person x = new Person("Edwards, Dave", 21,"ma");
        ...
        Person temp = new Person("Davidson, Greg", 24,"ma");
        //find it in list
        loc = search(p,temp);
